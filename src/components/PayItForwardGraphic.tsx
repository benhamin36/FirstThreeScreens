...
export default function PayItForwardGraphic() {
  return (
    <div className="relative w-full max-w-xl mx-auto">
      <LinedPaper
        className="rounded-[2rem] shadow-xl shadow-gray-200/60 overflow-hidden py-6 pl-10 pr-4 sm:py-8 sm:pl-14 sm:pr-8"
        showMargin
        marginPosition="32px"
      >
        {/* Title on paper */}
        ...
        <div className="relative flex items-end justify-between gap-0.5 sm:gap-3 px-1 sm:px-4">
          ...
          <div className="flex flex-col items-center gap-2 animate-fade-in-up flex-shrink-0">
            <div className="relative">
              ...
              <div className="absolute -top-2 left-1/2 -translate-x-1/2 z-10 w-6 h-6 rounded-full bg-accent-400 flex items-center justify-center shadow-md ring-2 ring-[#fefdf6]">
          ...
          <div className="flex flex-col items-center gap-2 animate-fade-in-up flex-shrink-0" style={{ animationDelay: '0.15s' }}>
            <div className="relative">
              {/* Checkmark + question mark bubbles */}
              <div className="absolute -top-2 left-1/2 -translate-x-1/2 z-10 flex gap-1">
                <div className="w-6 h-6 rounded-full bg-primary-400 flex items-center justify-center shadow-md ring-2 ring-[#fefdf6]">
                  <CheckCircle2 className="w-3.5 h-3.5 text-white" strokeWidth={2.5} />
                </div>
                <div className="w-6 h-6 rounded-full bg-secondary-400 flex items-center justify-center shadow-md ring-2 ring-[#fefdf6]">
                  <HelpCircle className="w-3.5 h-3.5 text-white" strokeWidth={2.5} />
                </div>
              </div>
          ...
          <div className="flex flex-col items-center gap-2 animate-fade-in-up flex-shrink-0" style={{ animationDelay: '0.3s' }}>
            <div className="relative">
              {/* Checkmark bubble */}
              <div className="absolute -top-2 left-1/2 -translate-x-1/2 z-10 w-6 h-6 rounded-full bg-secondary-400 flex items-center justify-center shadow-md ring-2 ring-[#fefdf6]">
                <CheckCircle2 className="w-3.5 h-3.5 text-white" strokeWidth={2.5} />
              </div>
              <div className="w-14 sm:w-20 md:w-24">
                <StudentFigure
